      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Feature Pills */}
            <FadeInUp delay={0.2} className="flex flex-wrap gap-3 mb-8 justify-center lg:justify-start">
            ...
            {/* Trust Indicators */}
            <FadeIn delay={0.6} className="flex items-center justify-center lg:justify-start gap-6 text-sm text-gray-500">
          ...
          <FadeInUp delay={0.3} className="relative flex justify-center lg:justify-start lg:-ml-4">
            <div className="relative">
              ...
              {/* Floating stats */}
              <ScaleIn delay={0.8} className="absolute -top-8 -left-8 bg-white rounded-2xl p-4 shadow-lg border border-primary-200">
              ...
              <ScaleIn delay={1} className="absolute -bottom-8 -right-8 bg-white rounded-2xl p-4 shadow-lg border border-secondary-200">
                <div className="text-center">
